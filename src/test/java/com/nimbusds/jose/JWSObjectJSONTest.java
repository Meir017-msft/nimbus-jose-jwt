...
public class JWSObjectJSONTest extends TestCase {
	...
	public void testForDocExample_generalWithTwoSignatures()
		throws Exception {
		...
		// Apply the first signature with the RSA key
		jwsObjectJSON.sign(
		...
		// Apply the second signature with the EC key
		jwsObjectJSON.sign(
		...
		// Get the public keys to allow recipients to verify
		// the signatures
...
//		System.out.println(json);
		...
		// Parse the JWS JSON
		jwsObjectJSON = JWSObjectJSON.parse(json);
